...
TRAIN_JSONL="${TRAIN_JSONL:-$ROOT_DIR/artifacts/datasets/e5_tulu3_train.jsonl}"
EVAL_JSONL="${EVAL_JSONL:-$ROOT_DIR/artifacts/datasets/e5_tulu3_eval.jsonl}"

REPORT_TO="${REPORT_TO:-none}"
ATTN_IMPLEMENTATION="${ATTN_IMPLEMENTATION:-}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/e5_tulu3_100k_2gpu}"
