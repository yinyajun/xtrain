...
MIX_JSONL="${MIX_JSONL:-$ROOT_DIR/artifacts/datasets/e4a_smol_constraints_mix.jsonl}"
SLICE_JSONL="${SLICE_JSONL:-$ROOT_DIR/artifacts/datasets/e4a_smol_constraints_token_matched.jsonl}"
COMMON_EVAL_CONFIG="${COMMON_EVAL_CONFIG:-smol-magpie-ultra}"

REPORT_TO="${REPORT_TO:-none}"
ATTN_IMPLEMENTATION="${ATTN_IMPLEMENTATION:-}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/e4a_smol_constraints_2gpu}"
...
CMD=(
  ...
  --run_name "e4a_smol_constraints_2gpu"
