...
from common import _has_training_generation_blocks, load_dataset_split
...
def _render_with_template(
    ...
    has_generation_blocks = _has_training_generation_blocks(effective_template)
...
def build_report(args: argparse.Namespace) -> str:
    ...
    if context["compare_tokenizer_name_or_path"]:
        try:
            compare_tokenizer = _load_tokenizer(context["compare_tokenizer_name_or_path"])
        except Exception as exc:
