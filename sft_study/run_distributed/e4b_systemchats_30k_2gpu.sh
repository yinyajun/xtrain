...
MIX_JSONL="$ROOT_DIR/artifacts/datasets/e4b_systemchats_mix.jsonl"
SLICE_JSONL="$ROOT_DIR/artifacts/datasets/e4b_systemchats_token_matched.jsonl"
ATTN_IMPLEMENTATION="${ATTN_IMPLEMENTATION:-}"
COMMON_EVAL_CONFIG="${COMMON_EVAL_CONFIG:-smol-magpie-ultra}"
OUTPUT_DIR="$ROOT_DIR/outputs/e4b_systemchats_30k_$RUN_SUFFIX"
...
python3 "$ROOT_DIR/scripts/dataset_utils.py" mix \
...
CMD=(
  ...
  --run_name "e4b_systemchats_30k_$RUN_SUFFIX" \
